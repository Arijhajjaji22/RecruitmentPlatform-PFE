    ...
    public class UserService
    {
        ...
        public async Task<int> RegisterUser(UserSignUpDto userSignUpDto)
        {
            ...
            var tempUser = new UserRegistrationTemp
            {
                ...
                Password = userSignUpDto.Password,  // Utilisation du mot de passe sans hachage
                ConfirmPassword = userSignUpDto.ConfirmPassword,  // Utilisation du mot de passe sans hachage
                Role = "Candidat",
                IsArchived = false,
